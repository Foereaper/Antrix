...
if(WIN32)
    ...
    if(MSVC)
        ...
        if(NOT CMAKE_GENERATOR MATCHES "Visual Studio 7")
            set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} /wd4302 /wd4996 /wd4355 /wd4244 /wd4985 /wd4267 /MP")
            set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /wd4302 /wd4996 /wd4355 /wd4244 /wd4267 /MP")
            set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} /wd4302 /wd4996 /wd4355 /wd4244 /wd4985 /wd4267 /MP")
            set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} /wd4302 /wd4996 /wd4355 /wd4244 /wd4985 /wd4267 /MP")
        endif()
